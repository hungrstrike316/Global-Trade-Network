...
def Construct_WTnet_Modularity(year):
	...
	dirOut = str(dirPre + 'NetworkX_modularity_npz/')
	...
	np.savez(str(dirOut + 'networkx_modularity_' + str(year) + '_' + str(num_countries) + 'countries.npz'),
		netwrk = mod_mtrx)
